    ...
    <div className="container mx-auto w-full max-w-7xl px-4 pb-32 pt-4 md:px-6 md:pb-12 md:pt-28 space-y-6 md:space-y-8">
      ...
      >
        <div className="grid md:gap-4 lg:grid-cols-12">
          ...
          <section className="flex flex-col items-start space-y-4 md:mb-0 md:block lg:col-span-8">
            <div className="relative flex w-full flex-col items-start space-y-4 overflow-hidden rounded-none bg-transparent p-0 text-left text-gray-20 shadow-none dark:text-gray-40 md:min-h-[360px] md:items-stretch md:justify-between md:rounded-lg md:border md:border-gray-80/80 md:p-8 md:text-left md:text-cryptoNight md:shadow-sm md:dark:border-white/10 md:dark:bg-secondary-50/10 md:dark:text-white">
              ...
              <div className="relative flex flex-1 flex-col justify-start self-stretch pt-1 md:justify-center md:pt-0">
                {/* Market Rate Pill */}
                <div className="mb-2 flex w-fit items-center gap-1.5 md:rounded-md md:border md:border-white/5 dark:md:border-white/10 py-1 text-[10px] font-bold uppercase text-primary-40  dark:text-white/75 md:hidden md:mb-3 md:gap-2 md:px-3 md:py-1 md:text-xs">
              ...
              <div className="hidden md:grid md:grid-cols-3 md:gap-4 md:pt-6">
                <div className="rounded-xl border border-gray-80/80 bg-white/70 p-4 backdrop-blur dark:border-white/10 dark:bg-secondary-50">
          ...
          {/* ─── Quick Actions ─── */}
          <section className="flex items-start justify-start gap-2 xs:gap-3 md:grid md:grid-cols-2 md:content-start md:gap-3 lg:col-span-4 md:rounded-lg md:border md:border-input  md:p-5">
            <QuickAction
              icon={<Plus size={22} />}
              label="Add Funds"
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 md:mt-4 md:gap-4 lg:grid-cols-12">
          ...
          <div className="flex flex-col space-y-4 md:rounded-lg md:border md:border-input md:bg-white md:p-5 md:dark:bg-secondary-50/10 lg:col-span-4">
            ...
            <div className="flex flex-1 min-h-[250px] flex-col items-center justify-center rounded-xl border border-black/5 bg-gray-50 p-8 text-center dark:border-white/10 dark:bg-secondary-50 md:rounded-lg">
